...
2. Go to your repository at [joemedicis/plone6runtime](https://github.com/joemedicis/plone6runtime).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `plone6runtime.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | plone6runtime.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | plone6runtime.example.com |
...
- [Backend Tests Workflow](https://github.com/joemedicis/plone6runtime/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/joemedicis/plone6runtime/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`joemedicis/plone6runtime-backend`) and Frontend (`joemedicis/plone6runtime-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of plone6runtime.example.com](https://github.com/joemedicis/plone6runtime/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/plone6runtime.example.com.yml` stack.
