...
```
DEPLOY_ENV=prod
DEPLOY_HOST=plone6runtime.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=plone6runtime-example-com
```
...
prod:
  hosts:
    plone6runtime.example.com:
      ansible_user: root
      host: plone6runtime
      hostname: plone6runtime.example.com
```
...
Deploy the stack defined in `devops/stacks/plone6runtime.example.com.yml` to the remote server with:
